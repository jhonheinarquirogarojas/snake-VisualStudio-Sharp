...
namespace Snake
{
    public partial class Form1 : Form
    {
        ...
        private void checkIFOffBoard()  //aca esta el texto cuando acaba el juego
        {
            ...
            {
                player.SoundLocation = "C:/Users/JHON/Desktop/Snake/Snake/imagenes/boom.wav";// direccion del sonido
                player.Play();// suena sonido
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i <= 9; i++)    //Comprueba si la serpiente ha comido un alimento
            {
                ...
                {
                    player.SoundLocation = "C:/Users/JHON/Desktop/Snake/Snake/imagenes/pop.wav";// direccion del sonido
                    player.Play();// sirve para el sonido .wab
                    snakeLength += 2;
                    SnakeLengthLabel.Text = snakeLength.ToString();
                    newFood();                    
                }
